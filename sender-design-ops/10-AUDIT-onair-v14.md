...
## 11. AUDITORÍA v2.0 — SOLO 1 VIDEO HERO + VIDEO PROTAGONISTA + CTA EDITORIAL (request "Sigue")
Feedback: "Solo 1 video en el heroe, aun se ven imágenes sobre el video y un bloque blanco que le quitan protagonismo al fondo animado que me gusto mucho, podemos hacer un cta mas profesional y editorial, me gusta mucho esta versión, podemos dar mas protagonismo al blanco y al azul — Sigue"
Cambios (aaa1e5b, BUILD 2.0, ?v=21):
- Hero: eliminado .hero-float (segundo video). Solo #film hero-smoke.mp4 5M H264 1920x1080 protagonista (opacity .92, sin blur). Un solo film = lectura Apple limpia, sin recuadro duplicado.
- Capacidades: eliminado bloque blanco light #f6f8fb que tapaba el desarme. Vuelve a .sec transparente .34/.14 con caps--text vidrio oscuro (rgba255 .06 blur12 + border .12, h3 #fff, p rgba255 .78, cap-n ice). Mantiene texto sin imágenes (ya en 1.9) pero ahora el tower/desarme se ve tras la tipografía — video protagonista recuperado, sin sobrecarga de fotos.
- CTA: de banda oscura a card blanca editorial radius18 shadow12 padding36, h3 #0d1526 uppercase 26-44px, p #42506a, btn-fill solid var(--blue) shadow, btn-line borde #0d1526/14 → hover blue. Más profesional, como keynote.
- Blanco/azul: kicker ice + dash 42px, hero-title em ice, sec k-n ice, CTA blanco puro + azul primario — protagonismo sin competir con humo negro. Todo ffmpeg H264 + posters + vendor autohospedado + scrub intacto.
Verificado: heroFloat 0, capsText 1, solo1Video css 1, BUILD 2.0, styles ?v21.
Awwwards re-score: Diseño 39/40 (+1), Creatividad 28/30, Contenido 19/20, Dev 10/10 = 96/100. Bloque blanco eliminado = video vuelve a ser hero.
